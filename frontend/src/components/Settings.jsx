...
export default function Settings({ settings, onChange, onClearChatMemory, onClearLocalProfile }) {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass rounded-2xl shadow-lg p-6 border border-white/20 backdrop-blur-sm bg-white/40 space-y-4">
      ...
      <div className="glass rounded-2xl shadow-lg p-6 border border-white/20 backdrop-blur-sm bg-white/40 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold py-2 px-4 rounded-lg"
          >
            Clear chat history
          </button>
          <button
